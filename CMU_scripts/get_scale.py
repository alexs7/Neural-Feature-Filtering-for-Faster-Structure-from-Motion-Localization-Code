...
def calc_scale_COLMAP(original_images_path, my_model_images_path):
    original_images = read_images_binary(original_images_path)
    model_images = read_images_binary(my_model_images_path)
...
print("Scale: ")
original_images_path = "/colmap_data/all_data_and_models/official_datasets/CMU-Seasons-Extended/slice2/ground-truth-database-images-slice2.txt"
my_model_images_path = "/colmap_data/all_data_and_models/official_datasets/CMU-Seasons-Extended/slice2/reconstruction/base/images.bin"

print(calc_scale_COLMAP(original_images_path, my_model_images_path))
