...
# CMU
results_cmu = [result_3, result_4, result_10, result_11]
...
for ransac_type in ransac_types:
    ...
    print(ransac_type + ":  %2.0f & %2.0f & %2.0f & %2.2f & %2.2f & %2.2f" % (inliers_mean, outliers_mean, iters_mean, time_mean, transerror_mean, roterror_mean))

print()
print("-------------- Matches Stats")

# matches numbers
slices = ["slice3", "slice4", "slice10", "slice11"]
print(slices)
