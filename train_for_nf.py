...
from data import getClassificationData, getClassificationDataOpenCV
...
dataset = sys.argv[1]
# NOTE: Be careful to use the correct db_path with the use_opencv flag
print("Did you use the correct db path and use_opencv flag?")
db_path = sys.argv[2]
use_opencv =(sys.argv[3] == '1')
...
if(dataset == "HGE" or dataset == "CAB" or dataset == "LIN"):
    ...
    print("Loading data..")
    if(use_opencv):
        data = getClassificationDataOpenCV(db_path)
    else:
