...
def create_vm(features_no):
    ...
    images_from_28_03 = read_images_binary("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/vanilla_model/2020-03-28/model/0/images.bin")
    ...
    for session_image_set in sessions_image_sets:
        ...
        print("         For future session " + str(t) + " images localised " + str(localised_images_no) + "/" + str(
            len(session_image_set)))
    ...
    for exponential_decay_value in exponential_decay_values:
        ...
        heatmap_matrix = np.where(base_visibility_matrix == vm_positive_value, Nt,
                                  0)  # apply oldest t on oldest data first
        t = t - 1
        ...
        print("Saving files...")
        np.savetxt(
            "/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/visibility_matrices/"+features_no+"/heatmap_matrix_avg_points_values_" + str(
                index_for_file_saving) + ".txt", heatmap_matrix_avg_points_values)
        np.save(
            "/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/visibility_matrices/"+features_no+"/session_images_weight_" + str(
                index_for_file_saving) + ".npy", session_images_weight)
        ...
        np.savetxt(
            "/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/visibility_matrices/"+features_no+"/heatmap_matrix_" + str(
                index_for_file_saving) + ".txt", heatmap_matrix)
