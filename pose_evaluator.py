...
complete_model_images_path = "/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/multiple_localised_models/2k/images.bin"
complete_model_all_images = read_images_binary(complete_model_images_path)

# load localised images names - This are from COLMAP
localised_images = []
path_to_query_images_file = "/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/feature_matching/2k/images_localised_no_base.txt"
...
matches_all = np.load("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/feature_matching/2k/matches_all_exp_dec_val_5.npy")

index_for_loading = "6" # refers to exponential decay value

print("Running for exponential decay value: 0." + index_for_loading)
...
vanilla_ransac_images_pose = np.load("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/RANSAC_results/2k/vanilla_ransac_images_pose_"+index_for_loading+".npy")
modified_ransac_images_pose = np.load("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/RANSAC_results/2k/modified_ransac_images_pose_"+index_for_loading+".npy")
...
print("For exponential decay value: 0."+ index_for_loading)
...
print("Saving Data..")
np.save("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/pose_evaluator/vanilla_ransac_results_t_"+index_for_loading+".npy", vanilla_ransac_results_t)
np.save("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/pose_evaluator/modified_ransac_results_t_"+index_for_loading+".npy", modified_ransac_results_t)
np.save("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/pose_evaluator/vanilla_ransac_results_a_"+index_for_loading+".npy", vanilla_ransac_results_a)
np.save("/Users/alex/Projects/EngDLocalProjects/LEGO/fullpipeline/colmap_data/data/pose_evaluator/modified_ransac_results_a_"+index_for_loading+".npy", modified_ransac_results_a)
