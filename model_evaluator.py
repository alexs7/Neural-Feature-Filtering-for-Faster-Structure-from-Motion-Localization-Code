...
np.savetxt(os.path.join(ml_path, "results_evaluator_"+str(random_percentage)+"_august_2022.csv"), results, delimiter=",")
np.save(os.path.join(ml_path, "image_pose_errors_all_"+str(random_percentage)+"_august_2022.npy"), np.array(image_pose_errors_all))