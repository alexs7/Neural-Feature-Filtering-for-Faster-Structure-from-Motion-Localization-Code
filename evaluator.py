...
register_image("colmap_data/data6/database.db", "colmap_data/data6/current_query_image", "colmap_data/data6/query_name.txt", "colmap_data/data6/model/0", "colmap_data/data6/new_model")
GP = get_query_image_global_pose()
P0 = get_pose_from_correspondences("colmap_data/data6/current_query_image/correspondences.txt")
...
show_projected_points("colmap_data/data6/current_query_image/query.jpg", K, P0, np.linalg.inv(P0), GP, points3D)

# repeat for next frames
for fname in sorted(glob.glob("colmap_data/data6/query_data/*.txt")):
    index_name = fname.split('_')[-1].split('.')[0]
    image_path = "colmap_data/data6/query_data/frame_"+index_name+".jpg"
