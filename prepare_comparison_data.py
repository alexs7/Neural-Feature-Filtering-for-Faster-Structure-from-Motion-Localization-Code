...
# python3 prepare_comparison_data.py colmap_data/CMU_data/slice3/ 5 (Note: you will need to run this first, "get_points_3D_mean_desc_ml_mnm.py")
...
# live points
# Note: you will need to run this first, "get_points_3D_mean_desc_ml_mnm.py" - to get the 3D points avg descs, and corresponding xyz coordinates (128 + 3) from the LIVE model.
...
points3D_xyz_live = points3D_info[:,128:131] # in my publication I used to get the points (x,y,z) seperately from the LIVE model, but here get_points_3D_mean_desc_ml_mnm.py already returns them
