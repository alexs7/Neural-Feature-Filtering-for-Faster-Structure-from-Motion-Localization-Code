# NOTE: 17/02/2023 - Not used anymore
...
# # Note: 13/02/2023: Use this file or delete ?
#
# import os
# import pdb
# import sys
...
# # command to run: python3 create_ML_training_data_CMU_all.py colmap_data/CMU_data/slice3/ colmap_data/CMU_data/slice4/ colmap_data/CMU_data/slice6/ colmap_data/CMU_data/slice10/ colmap_data/CMU_data/slice11/
#
...
#
#         img_index = 0
#         for img_id , img_data in live_model_images.items():
#             print("Doing image " + str(img_index + 1) + "/" + str(len(live_model_images.items())), end="\r")
#             descs = get_image_decs(db_live, img_id)
...
#                     matched = 1
#                     xyz = live_model_points3D[current_point3D_id].xyz  # np.float64
#
...
#     ml_db.commit()
#
#     print("Generating Data Info for all CMU slices...")
