...
def createDataForMatchNoMatchMatchabilityComparison(db, images, points3D, output_db_path):
    print("Creating data..")
...
createDataForMatchNoMatchMatchabilityComparison(db_live, live_model_images, live_model_points3D, output_path)
